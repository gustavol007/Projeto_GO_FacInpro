...
func main() {
	...
	fmt.Println("6 - Atv - Imprime Nome")
...
func digitaNome() {
	esc := 0
	var msn string
	fmt.Printf("Escolha um numero de (1 a 5): ")
	fmt.Scanln(&esc)
	switch esc {
	case 1:
		fmt.Print("Escreva o seu nome: ")
		fmt.Scanln(&msn)
		fmt.Println("Seu nome é " + msn)
	case 2:
		fmt.Print("Escreva o seu sobrenome: ")
		fmt.Scanln(&msn)
		fmt.Println("Seu sobrenome é " + msn)
	case 3:
		fmt.Print("Escreva o seu último nome: ")
		fmt.Scanln(&msn)
		fmt.Println("Seu último nome é " + msn)
	case 4:
		fmt.Print("Escreva o seu nome do meio: ")
		fmt.Scanln(&msn)
		fmt.Println("Seu nome do meio é " + msn)
	case 5:
		fmt.Print("Escreva o seu nome ao contrário: ")
		fmt.Scanln(&msn)
		fmt.Println("Seu nome ao contrario é " + msn)
	default:
